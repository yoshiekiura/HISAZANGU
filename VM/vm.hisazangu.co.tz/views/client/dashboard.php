            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Shareholder Dashboard</h4>
                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            ...
                                            <p class="text-muted">VIEW COMPANIES</p>
                                        </div>
                                        <div class="ml-auto">
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            ...
                                            <p class="text-muted">VIEW BROKERS</p>
                                        </div>
                                        <div class="ml-auto">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            <h3><i class="icon-share"></i></h3>
                                            <p class="text-muted">TRENDING SHARES</p>
                                        </div>
                                        <div class="ml-auto">
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            ...
                                            <p class="text-muted">RECENT NEWS</p>
                                        </div>
                                        <div class="ml-auto">
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets">
                                ...
                                <div class="d-flex no-block comment-row">
                                    <div class="p-2"><span class="round"><img src="<?php echo base_url();?>resources/assets/images/users/1.jpg" alt="user" width="50"></span></div>
                                ...
                                <div class="d-flex no-block comment-row border-top">
                                    <div class="p-2"><span class="round"><img src="<?php echo base_url();?>resources/assets/images/users/2.jpg" alt="user" width="50"></span></div>
                            ...
                            <div class="card-body bg-light">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <h4 class="font-light m-t-0">Trending Shares</h4></div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="card">
                        <div class="card-body">
                            <h4 class="font-light m-t-0">Exchange rates</h4>
