            ...
            <div class="wrapper main-wrapper row" style=''>
                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h3 class="title">Broker's Dashboard</h3>
              ...
              <div class="clearfix"></div>
                ...
                <div class="col-lg-6">
                    <section class="box">
                        <header class="panel_header">
                            <h2 class="title pull-left">Accepted Order</h2>
                    ...
                    <section class="box">
                        <header class="panel_header">
                            <h2 class="title pull-left">Rejected Orders</h2>
                    ...
                    <section class="box">
                        <header class="panel_header">
                            <h2 class="title pull-left">Closed Orders</h2>
