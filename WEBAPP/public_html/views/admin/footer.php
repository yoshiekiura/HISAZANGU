 <!-- ============================================================== -->
        ...
        <!-- ============================================================== -->
        <footer class="footer">
            © <?php echo date('Y').' '. config_item('application_name');?>
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
    ...
    <script src="<?php echo base_url('resources/template/');?>js/perfect-scrollbar.jquery.min.js"></script>
    <!--Wave Effects -->
    <script src="<?php echo base_url('resources/template/');?>js/waves.js"></script> 
    <!--Menu sidebar -->
    <script src="<?php echo base_url('resources/template/');?>js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
